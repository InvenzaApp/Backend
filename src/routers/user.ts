...
router.post('/', authMiddleware, (req, res) => {
   ...
   const { name, lastname, email, password, groupsIdList, permissions, admin } = req.body;
   ...
   const data = userModule.createUser(organization.id, name, lastname, email, password, groupsIdList, permissions, admin ?? false);
...
router.put('/:id', authMiddleware, (req, res) => {
   ...
   const token = tokenManager.getAccessToken(userId);
   const resourceId = Number(req.params.id);
   const { name, lastname, email, groupsIdList, permissions, admin } = req.body;
   ...
   userModule.updateUser(resourceId, name, lastname, email, groupsIdList, permissions, admin);
